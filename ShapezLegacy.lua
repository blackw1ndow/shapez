...
local script_url = 'https://raw.githubusercontent.com/blackw1ndow/shapez/main/ShapezLegacy.lua'
...
function checkBeforeLoad()
    ...
    if thisScript().filename ~= 'ShapezLegacy.lua' then os.rename(getGameDirectory() .. "/moonloader/" .. thisScript().filename, getGameDirectory() .. "/moonloader/ShapezLegacy.lua") end
