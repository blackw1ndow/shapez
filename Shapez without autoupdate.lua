...
function checkBeforeLoad()
	...
	if thisScript().filename ~= 'Shapez without autoupdate.lua' then os.rename(getGameDirectory() .. "/moonloader/" .. thisScript().filename, getGameDirectory() .. "/moonloader/Shapez without autoupdate.lua") end
